    ...
    function oauthInterceptor($q, $rootScope, OAuthToken) {
        return {
            ...
            responseError: function(rejection) {
                ...
                if (401 === rejection.status && (rejection.data && "expired_token" === rejection.data.error) || rejection.headers("www-authenticate") && 0 === rejection.headers("www-authenticate").indexOf("Bearer")) {
                    $rootScope.$emit("oauth:error", rejection);
                }
